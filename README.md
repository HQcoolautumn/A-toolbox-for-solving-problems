...
视频处理与 AI 字幕 (Video Processing & AI Subtitles)

AI 字幕识别：内置 AI 字幕功能。

(AI Subtitle Recognition: Built-in AI-powered subtitle generation.)
...
显卡加速：提供本地显卡加速选项（需自行配置环境，不适合小白用户）。
...
三维预览：支持较小体积的三维模型文件预览（存在部分兼容性问题）。

(3D Preview: Preview small-sized 3D model files.)

在线/本地翻译：提供可选的在线或本地翻译功能。

(Translation: Optional online or local translation feature.)
